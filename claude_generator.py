...
def get_bedrock_client():
  ...
  return boto3.client('bedrock-runtime', region_name=os.environ.get('AWS_DEFAULT_REGION', os.environ.get('AWS_REGION')), config=config)
...
"""
    ...
    model_id = os.environ.get('AWS_BEDROCK_MODEL_ID', 'us.anthropic.claude-3-5-sonnet-20241022-v2:0')
    ...
    try:
        ...
        if 'inference profile' in str(e).lower():
            # Try with a cross-region inference profile
